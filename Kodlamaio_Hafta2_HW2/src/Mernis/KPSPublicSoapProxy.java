...
public class KPSPublicSoapProxy implements Mernis.KPSPublicSoap {
  private String _endpoint = null;
  private Mernis.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new Mernis.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public Mernis.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
